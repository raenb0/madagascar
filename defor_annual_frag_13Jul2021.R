...
projection(frag00)
res(frag00)
projection(protected_areas)
class(cfm_pre05)


# Extract average forest fragmentation in CFM and PAs ---------------------
library(prioritizr)
...
ggplot(data = frag_means) +
  geom_point(mapping = aes(x = year, y = frag_cfm), color = "blue") +
  geom_line(mapping = aes(x = year, y = frag_cfm), group = 1, color = "blue") +
  geom_point(mapping = aes(x = year, y = frag_pa), color = "red")+
  geom_line(mapping = aes(x = year, y = frag_pa), group = 1, color = "red") +
  geom_point(mapping = aes(x = year, y = frag_national), color = "green")+
  geom_line(mapping = aes(x = year, y = frag_national), group = 1, color = "green") +
