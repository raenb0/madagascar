...
#No longer necessary - generated a separate sample of points from renewed CFM areas, to use for matching
...
# #create version of CFM data with only renewed (implemented) CFM sites #no longer necessary, created separate sample
...
cfm_pa_data_90m_no_na <- drop_na(cfm_pa_data_90m_no_dist) #remove sample points with NA values
...
Treat <- cfm_pa_data_90m_no_na$CFM #using version with NA values this time
